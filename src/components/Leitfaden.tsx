...
export default function Leitfaden() {
  return (
    <section id="leitfaden" className="py-20 px-4 bg-white">
      <div className="max-w-6xl mx-auto text-center">
        {/* Headline */}
        <h2
          className="text-4xl font-bold text-heroBg"
          data-aos="fade-up"
        ...
        <p
          ...
          data-aos-duration="800"
        >
          In drei einfachen Schritten zum professionellen Kfz-Gutachten – schnell, unabhängig und direkt bei Ihnen vor Ort.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-10 mt-16">
          {/* STEP 1 */}
          <div
            className="p-8 rounded-xl shadow-lg bg-gray-50 hover:shadow-xl transition"
            data-aos="fade-up"
            data-aos-delay="0"
          ...
          >
            ...
            <h3 className="text-2xl font-semibold mt-6 text-heroBg">
